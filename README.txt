...
#Before reading the data, we visualised the dataset to understand the content and structure that enabled us to  select the correct methods for our analysis.
...
#Conclusion
#We were able to produce information necessary for major studios to acquire subsidiaries, by finding the profits made by various studios
#Enable a user to pick movies to watch based on  inputs which are used to filter DataFrame to make Movie Suggestions
